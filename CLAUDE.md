...
- `cron/harvest-scraped-sources` — daily (5am UTC) scraper for non-RSS sources (IMO, ISA, FAO Fisheries, UN BBNJ, IISD ENB), uses Jina
...
- `public.stories` — title, link, source_name, topic, source_type, published_at, description (RSS), short_summary, full_summary, is_pro
