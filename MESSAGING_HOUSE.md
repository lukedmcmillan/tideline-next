# Tideline Messaging House
## Locked March 2026 — Reference before writing any copy

---

## NON-NEGOTIABLE RULES
- No em dashes. Ever. Use a full stop, a colon, or rewrite the sentence.
- No "AI" language. No "AI-powered", "intelligent", "smart". Say what it does.
- No "7am" as a selling point. It is a delivery detail, not a feature.
- No environmental cause language. Tideline is for professionals, not campaigners.
- No feature lists in headlines. Name the person or the pain, not the product.
- No exclamation marks. Ever.
- No "we" in product copy. Use "Tideline" or "your" only.
- No "newsletter". Tideline is not a newsletter.
- No "cutting-edge", "revolutionary", "game-changer", "passionate about".
...
## INTELLIGENCE AGENT HEADLINE
Ask Tideline anything.
...
## BRIEF SECTION NAMES (always uppercase, never varied)
THE WATCH — lead story, most significant event of last 24 hours
GOVERNANCE — policy and regulatory developments
THE TRACKER — one live tracker update with current status
SIGNAL — one story most people will miss but professionals should not

## BRIEF EMAIL SUBJECT LINE FORMAT
Tideline · Wednesday 25 March 2026
Format: "Tideline · [Weekday] [Full date]". Dot separator. No teaser text.

---

## WHO IT IS FOR — six segments, one sentence each
...
Line: Cross-reference ISA contractor decisions with blue finance flows. Find the pattern in 18 months of ratification data. Tideline turns governance data into investigative leads.
...
Agent search placeholders (cycle every 4 seconds):
1. What has changed in BBNJ ratification this quarter?
2. Show me all ISA contractor decisions since 2024.
...
em dash (—)
AI-powered / powered by AI / leverages AI
cutting-edge / state-of-the-art / next-generation
passionate about / dedicated to / committed to
save the ocean / protect our seas / any cause language
newsletter
delivered before 7am (as a selling point)
comprehensive / all-in-one / everything you need
exclamation marks
