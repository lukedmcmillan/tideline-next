      ...
      <section id="audience" className="section-pad" style={{ padding: "80px 48px", maxWidth: 1200, margin: "0 auto" }}>
        ...
        <div className="audience-grid">
          {[
            ...
            { label: "Ocean Investors & Funds", headline: "The signal before the consensus forms.", body: "In a sector still building its information infrastructure, Tideline is the daily read for fund managers, blended finance desks and impact investors who need to know what shifted before the rest of the market catches up. Track which funds are backing which ocean companies, which deals are closing, and where institutional capital is moving \u2014 as soon as it becomes public." },
          ].map((seg, i) => (
