...
export const STARTER_SETS: Record<JobType, StarterEntity[]> = {
  marine_lawyer: [
    ...
    { name: "UN Division for Ocean Affairs", tracker_tags: ["bbnj"] },
    { name: "BBNJ Treaty", tracker_tags: ["bbnj"] },
    ...
    { name: "London Convention / Protocol", tracker_tags: ["imo-shipping"] },
    { name: "OSPAR Commission", tracker_tags: ["30x30"] },
    { name: "CCAMLR", tracker_tags: ["30x30", "iuu"] },
    { name: "Nairobi Convention", tracker_tags: ["30x30"] },
    { name: "Baltic Marine Environment Protection Commission", tracker_tags: ["30x30"] },
  ],

  esg_analyst: [
    { name: "TNFD", tracker_tags: ["blue-finance"] },
    { name: "ISSB", tracker_tags: ["blue-finance"] },
    ...
    { name: "Global Reporting Initiative", tracker_tags: ["blue-finance"] },
  ],
  ...
  blue_finance: [
    ...
    { name: "TNFD", tracker_tags: ["blue-finance"] },
    { name: "ISSB", tracker_tags: ["blue-finance"] },
    { name: "IFC", tracker_tags: ["blue-finance"] },
  ...
  shipping_compliance: [
    { name: "International Maritime Organization", tracker_tags: ["imo-shipping"] },
    { name: "MEPC", tracker_tags: ["imo-shipping"] },
    ...
    { name: "Lloyd's Register", tracker_tags: ["imo-shipping"] },
    { name: "Poseidon Principles", tracker_tags: ["imo-shipping", "blue-finance"] },
    { name: "World Trade Organization", tracker_tags: ["wto-fisheries"] },
    { name: "Ballast Water Management Convention", tracker_tags: ["imo-shipping"] },
  ],
