...
const SOURCES: ScrapedSource[] = [
  ...
  },
  {
    name: "CBD",
    sourceType: "cbd",
    urls: ["https://www.cbd.int/news"],
    linkPattern: /href="((?:https:\/\/www\.cbd\.int)?\/(?:doc|news|article)\/[^"]+)"/gi,
  ...
  },
  {
    name: "IWC",
    sourceType: "iwc",
    urls: ["https://iwc.int/en/news"],
    linkPattern: /href="((?:https:\/\/iwc\.int)?\/en\/news\/[^"]+)"/gi,
    baseUrl: "https://iwc.int",
    topic: "whales",
    storySourceType: "reg",
  },
  {
    name: "SeafoodSource",
    sourceType: "seafoodsource",
    urls: ["https://www.seafoodsource.com/news"],
    linkPattern: /href="((?:https:\/\/www\.seafoodsource\.com)?\/news\/[^"]+)"/gi,
    baseUrl: "https://www.seafoodsource.com",
    topic: "fisheries",
    storySourceType: "media",
  },
  {
    name: "ICCAT",
    sourceType: "iccat",
    urls: ["https://www.iccat.int/en/meetingscurrent.html"],
    linkPattern: /href="((?:https:\/\/www\.iccat\.int)?\/en\/(?:meet|doc|RecsRegs)[^"]+)"/gi,
    baseUrl: "https://www.iccat.int",
    topic: "fisheries",
    storySourceType: "reg",
  },
  {
    name: "OSPAR",
    sourceType: "ospar",
    urls: ["https://www.ospar.org/news"],
    linkPattern: /href="((?:https:\/\/www\.ospar\.org)?\/news\/[^"]+)"/gi,
    baseUrl: "https://www.ospar.org",
    topic: "governance",
    storySourceType: "reg",
  },
  {
    name: "MSC",
    sourceType: "msc",
    urls: ["https://www.msc.org/media-centre/news-opinion"],
    linkPattern: /href="((?:https:\/\/www\.msc\.org)?\/media-centre\/news-opinion\/[^"]+)"/gi,
    baseUrl: "https://www.msc.org",
    topic: "fisheries",
    storySourceType: "ngo",
  },
  {
    name: "TradeWinds",
    sourceType: "tradewinds",
    urls: ["https://www.tradewindsnews.com/news"],
    linkPattern: /href="((?:https:\/\/www\.tradewindsnews\.com)?\/[^"]*(?:news|article|tankers|gas|offshore|regulation)[^"]+)"/gi,
