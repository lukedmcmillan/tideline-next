...
- document_type: you MUST return one of these exact strings only: treaty, resolution, report, regulation, scientific_paper, ngo_report, government_document, court_filing, other. Never return any other value. Map international agreements and conventions to treaty. Map directives and decisions to regulation or resolution. If uncertain use other.
