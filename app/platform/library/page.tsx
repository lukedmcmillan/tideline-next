...
const UI = "var(--font-ui), 'Plus Jakarta Sans', -apple-system, sans-serif";
...
export default function LibraryPage() {
  return (
    ...
    <div style={{ maxWidth: 480, margin: "80px auto", padding: "0 28px" }}>
      <h1 style={{ fontFamily: UI, fontSize: 22, fontWeight: 600, fontStyle: "normal", opacity: 0.5, margin: "0 0 8px" }}>Your library is empty.</h1>
