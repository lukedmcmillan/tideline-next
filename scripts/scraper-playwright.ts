...
const SOURCES: PlaywrightSource[] = [
  ...
  },
  {
    ...
    defaultType: "report",
    is_primary_source: true,
    url: "https://openknowledge.fao.org/collections/fisheries-and-aquaculture",
    waitFor: "a[href*='.pdf'], .item, .list-item, article",
    scrollToBottom: true,
  },
  {
    name: "FAO Fisheries & Aquaculture p2",
    domain: "fao.org",
    defaultOrg: "Food and Agriculture Organization of the United Nations",
    defaultType: "report",
    is_primary_source: true,
    url: "https://openknowledge.fao.org/collections/fisheries-and-aquaculture?page=2",
    waitFor: "a[href*='.pdf'], .item, .list-item, article",
    scrollToBottom: true,
  },
  {
    name: "FAO Fisheries & Aquaculture p3",
    domain: "fao.org",
    defaultOrg: "Food and Agriculture Organization of the United Nations",
    defaultType: "report",
    is_primary_source: true,
    url: "https://openknowledge.fao.org/collections/fisheries-and-aquaculture?page=3",
    waitFor: "a[href*='.pdf'], .item, .list-item, article",
    scrollToBottom: true,
  },
  {
    name: "FAO Ocean Governance",
    domain: "fao.org",
    defaultOrg: "Food and Agriculture Organization of the United Nations",
    defaultType: "report",
    is_primary_source: true,
    url: "https://openknowledge.fao.org/collections/ocean-governance",
    waitFor: "a[href*='.pdf'], .item, .list-item, article",
    scrollToBottom: true,
  },
  {
    ...
    defaultOrg: "Organisation for Economic Co-operation and Development (OECD)",
    defaultType: "report",
    is_primary_source: true,
    url: "https://www.oecd-ilibrary.org/environment/ocean",
    waitFor: "a[href*='.pdf'], .publication, .result, article",
    scrollToBottom: true,
  },
  {
    name: "IUCN Marine Publications",
    domain: "iucn.org",
    defaultOrg: "International Union for Conservation of Nature (IUCN)",
    defaultType: "report",
    is_primary_source: true,
    url: "https://www.iucn.org/resources/publications?topic=marine",
    waitFor: "a[href*='.pdf'], .card, .node, article",
    scrollToBottom: true,
  },
];
